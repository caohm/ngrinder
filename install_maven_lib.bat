...
call mvnw install:install-file -Dfile=lib/grinder-core-3.9.1.jar -DgroupId=net.sf.grinder -DartifactId=grinder-core -Dversion=3.9.1 -Dpackaging=jar -DcreateChecksum=true
